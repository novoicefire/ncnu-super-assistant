...
export const updateHistory = [
  {
    ...
    type: "major", 
    title: "重大界面改版與深色模式上線",
    description: "首頁全面Dashboard化改版，手機版選單優化，新增深色模式支援" +
      "\n" +
      "提供更直觀的資訊總覽與跨裝置一致的使用體驗",
    features: [
      "🏠 首頁Dashboard化：今日狀態區、公告區、課表預覽三合一",
      "📢 革命性公告區：支援圖片、影片、自訂按鈕的多媒體內容",
      "📱 手機版選單優化：漢堡選單與IBS專區/主題切換並排按鈕",
      "🌙 深色模式完整實現：全站深色主題切換與視覺適配",
      "🎯 統一視覺設計：公告區與今日狀態卡片樣式一致化"
    ],
    technical: [
      "實作AnnouncementCard組件替換SystemStatus區域",
      "公告區支援滾輪滾動、YouTube嵌入、連結預覽功能",
      "修復免責聲明與其他組件的深色模式文字顯示",
      "解決Navbar IBS專區按鈕桌面版/手機版重複顯示問題",
      "完整響應式設計適配與CSS變數主題系統建立"
    ]
  },
  {
    version: "v3.2.0",
