...
- **衝堂檢測**：自動檢測時間衝突，支援顯示/灰色標示/完全隱藏三種模式
- **雲端同步**：Google 登入整合，課表資料雲端儲存
- **社群智慧**：顯示課程熱度，了解其他同學的選課趨勢
- **手機版優化**：全新的搜尋懸浮按鈕與 BottomSheet 介面，操作更流暢
- **學年設定**：直覺的行內入學年/畢業年設定，隨時調整
- **必修課追蹤面板**：🆕 直接整合於排課頁面，邊排課邊檢查畢業門檻
- **進度一鍵同步**：🆕 支援從已存課表自動同步至必修課進度
- **課程代碼搜尋**：🆕 新增 Course ID 搜尋欄位，精確找課
...
│   │   │   ├── 1_CoursePlanner/ # 智慧排課系統 (含必修課追蹤整合)
...
- **服務條款系統**：8 章節完整服務條款與免責聲明
- **版本控制機制**：更新條款版本號強制重新顯示同意視窗
- **同意記錄**：localStorage 儲存同意版本與日期
- **隨時可查**：可從導航欄隨時重新開啟服務條款
- **非官方性質**：明確說明與學校官方的關係
